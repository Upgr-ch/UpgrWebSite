...
const PACK_COMPLET = {
  ...
  desc: "Masterclasses « L'Art de Transmettre #1 » et « Masterclasse L'Art de Transmettre #2 : Faire vivre la transmission » + 2 ebooks",
  tag:  'Pack Complet-Acheteur',
};

const PACK_COMPLET_3X = {
  nom:  "Pack Complet — 2 Masterclasses + 2 ebooks",
  desc: "Paiement en 3 fois · Masterclasses « L'Art de Transmettre #1 » et « Masterclasse L'Art de Transmettre #2 : Faire vivre la transmission » + 2 ebooks",
  tag:  'Pack Complet-Acheteur',
};
